export const strings = {
  ...
  MemoryOfChaos: "Пам'ять про хаос",
  NoDataYet: "Поки немає даних",
  IsDone: "Виконано",
  PlayerLevel: "Рівень.",
  AccountLogin: "Увійти",
  ModifyHomePage: "Редагувати домашню сторінку",
