![星穹觀星者2宣傳Banner](./readme/image/close_beta/close_beta/banner.png)
...
### <span style="color:#339966">封測人員招募 (直至 2024/01/11 08:00 UTC+8)
...
![yukina4096](./readme//螢幕擷取畫面%202024-01-08%20193615.png)

回答以下問題，並加入我們的 Discord 伺服器

- 使用的平台(Android / iOS)
- 接收封測的電郵 (iOS 的話請記得提供者 Apple ID 的電郵哦)
- 星穹 UID

> P.S. UID 在這邊是用於測試的時候能夠獲取特殊權限，然後也方便我們紀錄錯誤之類的 ~ 所以還請測試時用那個 UID 的帳戶登錄，Thxx
> <br>
...
- 《Furina》[Somebody](https://github.com/ilikecatgirls)
  ![用黑塔的圖片代替](./readme/image/close_beta/StarRail_Image_1701573293.png)

星穹觀星者 2 將會提供以下功能:

- 角色、光錐、遺器資料查詢![角色、光錐、遺器資料查詢](./readme/image/close_beta/Screenshot_20240107-180813.png)
- 角色高清圖(不要問我為啥 AKA 寫真圖) (為了拍圖 差點把電腦顯卡燒了 QQ)![角色高清圖](./readme/image/close_beta/Screenshot_20240107-181159.png)
- 星穹鐵道活動列表![星穹鐵道活動列表](./readme/image/close_beta/Screenshot_20240108-141346.png)
- 兌換碼![兌換碼](./readme/image/close_beta/Screenshot_20240108-141414.png)
- 展示自己帳戶的即時開拓力、每日任務進度、派遣委託![即時開拓力、每日任務進度、派遣委託](./readme/image/close_beta/Screenshot_20240107-183711.png)
- 查看自己的混沌回憶紀錄
- 展示活動列表、地圖、兌換碼功能。
- 角色推薦配隊、光錐、遺器。![推薦](./readme/image/close_beta/Screenshot_20240107-181220.png)
- 開拓者留言功能![留言功能](./readme/image/close_beta/Screenshot_20240107-183842.png)
...
## 源碼僅供學習參考，不得自行分發專案内源碼，如有任何疑問，歡迎到我們的官方 Discord 伺服器詢問
