...
| 角色&遺器評分                                  | 練度排行榜                                        | 混沌排行榜                                      |
| ---------------------------------------------- | ------------------------------------------------- | ----------------------------------------------- |
| ![Alt text](./image/screen_score_function.png) | ![Alt text](./image/screen_score_leaderboard.png) | ![Alt text](./image/screen_moc_leaderboard.png) |

| 留言功能                                | 查詢 UID                                   | 用戶角色展示櫃                                 |
| --------------------------------------- | ------------------------------------------ | ---------------------------------------------- |
| ![Alt text](./image/screen_comment.png) | ![Alt text](./image/screen_uid_search.png) | ![Alt text](./image/screen_user_char_show.png) |

| 角色資料查詢                                  | 光錐資料查詢                                       | 遺器資料查詢                                   |
| --------------------------------------------- | -------------------------------------------------- | ---------------------------------------------- |
| ![角色資料查詢](./image/screen_char_list.png) | ![光錐資料查詢](./image/screen_lightcone_list.png) | ![遺器資料查詢](./image/screen_relic_list.png) |

| 活動列表                                   | 即時帳戶狀態                             | 混沌回憶紀錄                                   |
| ------------------------------------------ | ---------------------------------------- | ---------------------------------------------- |
| ![活動列表](./image/screen_event_list.png) | ![開拓力](./image/screen_acc_status.png) | ![混沌回憶紀錄](./image/screen_moc_record.png) |
