    ...
    if(level <= levelMax[x] && level >= levelMin[x]){
      ...
      */
      return {
        ...
        def: charLevelData[x].defenseBase + charLevelData[x].defenseAdd * (level - levelMin[x]),
        speed: charLevelData[x].speedBase + charLevelData[x].speedAdd * (level - levelMin[x]),
    ...
    if(level <= levelMax[x] && level >= levelMin[x]){
      ...
      */
      return {
        ...
        def: lcLevelData[x].defenseBase + lcLevelData[x].defenseAdd * (level - levelMin[x])
      };
    }
  }
