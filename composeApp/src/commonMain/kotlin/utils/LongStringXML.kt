...
class LongStringXML() {
    ...
    fun PublicCharDesc(appLanguage: Language.AppLanguage): String {
    ...
    fun TrailblazerNotiTaggedU(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun UIDOnlySupportFullUID(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun LoginViaPCToGetCookies(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun SelectServerAndPasteCookies(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun CommentOverLimit(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun DonationRemoveAds(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun AboutTheAppContent(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun LoginHint(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun LoginPolicy(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun GithubStarPlease(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
    ...
    fun demo(appLanguage: Language.AppLanguage): String {
        return when (appLanguage) {
