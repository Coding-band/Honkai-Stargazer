const AttributeImage = {
  ...
  crit_dmg: require("../ui_icon/ic_crit_dmg.webp"),
  crit_rate: require("../ui_icon/ic_crit_rate.webp"),
  def: require("../ui_icon/ic_def.webp"),
  effect_hit: require("../ui_icon/ic_effect_hit_rate.webp"),
  energy: require("../ui_icon/ic_energy.webp"),
  sp: require("../ui_icon/ic_energy.webp"),
  sp_rate: require("../ui_icon/ic_energy_regeneration_rate.webp"),
